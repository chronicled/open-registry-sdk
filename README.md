...
- Ethereum node up and running on mainnet, accepting RPC requests through http protocol. Find how to do this in official instructions: https://github.com/ethereum/go-ethereum/wiki/Building-Ethereum.
