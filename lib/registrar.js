...
Registrar.prototype.addRegistrant = function(address, data) {
  ...
  return this.registrar.addAsync(address, '0x' + regData.encodeHex(), {from: this.address, gas: 2000000});
};
...
Registrar.prototype.editRegistrant = function(address, data, isActive) {
  ...
  return this.registrar.editAsync(address, '0x' + regData.encodeHex(), isActive, {from: this.address, gas: 2000000});
};
...
Registrar.prototype.setRegistrar = function(registrarAddress) {
  ...
  return this.registry.configureAsync(registrarAddress, {from: this.address, gas: 2000000});
};
...
Registrar.prototype.createStandardSchema = function(schema) {
  ...
  return this.registry.createStandardSchemaAsync(schema.name, schema.description, schema.definition, {from: this.address, gas: 2000000});
};
