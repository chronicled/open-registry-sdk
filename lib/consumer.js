...
/**
 * Get standard Thing schema structure from the blockchain by index.
 * @function
...
Consumer.prototype.getStandardSchema = function() {
  return this.registry.standardSchemaAsync({from: this.address}).then(function(schema) {
    return {
      name: schema[0],
...
Consumer.prototype.getSchema = function(index) {
  return this.registry.schemasAsync(index, {from: this.address}).then(function(schema) {
    return {
      name: schema[0],
      description: schema[1],
      definition: schema[2]
...
Consumer.prototype.getSchemas = function() {
  var self = this;
  return self.registry.getSchemasLengthAsync({from: self.address}).then(function(length) {
    var promises = [];
