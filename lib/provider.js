...
var MultiAccessDeployerSdk = require('./multi-access-deployer.js');
...
// TODO: Update with proper deployed address
var multiAccessFactoryAddress = '0x';
var multiAccessFactoryABI = [{"constant":false,"inputs":[{"name":"cosigners","type":"address[]"}],"name":"createMultiAccessContract","outputs":[{"name":"","type":"bool"}],"payable":false,"type":"function"},{"constant":true,"inputs":[{"name":"","type":"address"},{"name":"","type":"uint256"}],"name":"multiAccessCosigners","outputs":[{"name":"","type":"address"}],"payable":false,"type":"function"},{"constant":true,"inputs":[],"name":"owner","outputs":[{"name":"","type":"address"}],"payable":false,"type":"function"},{"constant":false,"inputs":[{"name":"cosigners","type":"address[]"}],"name":"createMultiAccessRegistrarContract","outputs":[{"name":"","type":"bool"}],"payable":false,"type":"function"},{"constant":true,"inputs":[],"name":"mainMultiAccess","outputs":[{"name":"","type":"address"}],"payable":false,"type":"function"},{"inputs":[],"payable":false,"type":"constructor"},{"anonymous":false,"inputs":[{"indexed":false,"name":"multiAccess","type":"address"},{"indexed":false,"name":"cosigners","type":"address[]"}],"name":"Created","type":"event"}];

var gasLimit = 1400000; // For the time of ongoing DoS attack.
...
function Provider(rpcUrl, userType, secret, contracts, finalCallback) {
  ...
  if (secret) {
    ...
    engine.addProvider(new HookedWalletSubprovider({
      ...
      signTransaction: function(txData, cb) {
        // Static gas price
        var gasPrice = self.web3.toWei(20, 'shannon');
  ...
  this.multiAccessFactoryAddress = multiAccessFactoryAddress;
  this.multiAccessFactoryABI = multiAccessFactoryABI;
  if (contracts) {
    ...
    this.multiAccessFactoryAddress = contracts.multiAccessFactoryAddress || this.multiAccessFactoryAddress;
    this.multiAccessFactoryABI = contracts.multiAccessFactoryABI || this.multiAccessFactoryABI;
  }
...
Provider.prototype.instantiateSdk = function(userType) {
  ...
  switch (userType) {
    ...
    break;
    case 'deployer':
      this.sdk = new MultiAccessDeployerSdk(this);
      break;
  }
...
/**
 * Get MultiAccessFactory contract instance.
 * @function
 * @return {Contract} that allows creation of MultiAccess contracts
 */
Provider.prototype.getMultiAccessFactory = function() {
  return Promise.promisifyAll(this.web3.eth.contract(this.multiAccessFactoryABI).at(this.multiAccessFactoryAddress));
};
