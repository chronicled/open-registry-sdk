 ...
 * @param {string} [secret] private key to sign transactions. Only for 'registrant' and 'registrar' functions.
 * @param {Object} [contracts] contract addresses and ABI, defaults to official contracts.
 * @param {function} [finalCallback] callback that will be called with Sdk instance as only parameter.
