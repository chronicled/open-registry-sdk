...
function Provider(rpcUrl, secret, contracts, userType, finalCallback) {
  var self = this;
  ...
  var sdkReady = this.instantiateSdk(userType);
  if (finalCallback) {
